package com.jungle.bigdata.ct.consumer.dao;
...
import com.jungle.bigdata.ct.consumer.bean.Calllog;
...
public class HBaseDao extends BaseDao {
    ...
    public void init() throws Exception {
        ...
        createTableXX(Names.TABLE.getValue(),"com.jungle.ct.consumer.coprocessor.InsertCalleeCoprocessor",ValueConstant.REGION_COUNT,Names.CF_CALLER.getValue(),Names.CF_CALLEE.getValue());
